export const profile = {
  ...
  leetcode: "https://leetcode.com/u/Rohit_8800",
  tagline:
    "I build full-stack products and wire them up to LLMs — RAG pipelines, multi-agent systems, and AI features that ship to production.",
};
...
export const achievements = [
  ...
  },
  {
    ...
    detail: "Full Stack Dev, via Internshala",
  },
  { label: "Certification", value: "Generative AI", detail: "Google Cloud" },
  {
    label: "Recognition",
    value: "Top Performer",
    detail: "Logic League — AI & analytical reasoning",
  },
];
